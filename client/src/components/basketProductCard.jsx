            ...
            <div className="row g-0">
                ...
                <div className="col-md-3 text-center">
                    ...
                    <div className = "d-flex flex-row justify-content-center align-items-center">
                        <button type="button" className="btn btn-link m-0" onClick={()=>onDecrement(basketCard.product._id)}><i class="bi bi-dash-square"></i></button>
                        <h6>{basketCard.value}</h6>
                        <button type="button" className="btn btn-link" onClick={()=>onIncrement(basketCard.product._id)}><i class="bi bi-plus-square"></i></button>
                    </div>
                </div>
                <div className="col-md-3 text-center">
